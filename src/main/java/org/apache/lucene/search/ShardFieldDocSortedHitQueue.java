 ...
 * Info:rebirth-search-core ShardFieldDocSortedHitQueue.java 2012-7-6 14:29:33 l.xue.nong$$
 */
...
public class ShardFieldDocSortedHitQueue extends PriorityQueue<ShardFieldDoc> {
	...
	public void setFields(SortField[] fields) {
		...
		try {
			...
			throw new RebirthIllegalStateException("failed to get comparator", e);
		}
	}
