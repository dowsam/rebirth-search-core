 ...
 * Info:rebirth-search-core CustomFieldQuery.java 2012-7-6 14:30:43 l.xue.nong$$
 */
...
public class CustomFieldQuery extends FieldQuery {
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public CustomFieldQuery(Query query, IndexReader reader, boolean phraseHighlight, boolean fieldMatch)
			throws IOException {
