 ...
 * Info:rebirth-search-core InternalQueryFacet.java 2012-7-6 14:30:42 l.xue.nong$$
 */
...
public class InternalQueryFacet implements QueryFacet, InternalFacet {
	...
	/* (non-Javadoc)
	 * @see cn.com.rebirth.search.core.search.facet.query.QueryFacet#count()
	 */
	public long count() {
		return count;
	}
	...
	/* (non-Javadoc)
	 * @see cn.com.rebirth.search.core.search.facet.query.QueryFacet#getCount()
	 */
