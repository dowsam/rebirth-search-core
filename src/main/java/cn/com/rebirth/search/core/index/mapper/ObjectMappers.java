 ...
 * Info:rebirth-search-core ObjectMappers.java 2012-7-6 14:29:09 l.xue.nong$$
 */
...
public class ObjectMappers implements Iterable<ObjectMapper> {
	...
	public ObjectMappers concat(ObjectMappers mappers) {
		return new ObjectMappers(new ImmutableList.Builder<ObjectMapper>().addAll(objectMappers).addAll(mappers)
				.build());
	}
