 ...
 * Info:summall-search-core InternalShortTermsFacet.java 2012-3-29 15:02:44 l.xue.nong$$
 */
...
/**
 * The Class InternalShortTermsFacet.
 *
 * @author l.xue.nong
 */
public class InternalShortTermsFacet extends InternalTermsFacet {
	...
	public static class ShortEntry implements Entry {
		...
		/**
		 * Instantiates a new short entry.
		 *
		 * @param term the term
	...
	/**
	 * Instantiates a new internal short terms facet.
	 */
	 ...
	 */
	public InternalShortTermsFacet(String name, ComparatorType comparatorType, int requiredSize,
			Collection<ShortEntry> entries, long missing, long total) {
		this.name = name;
	...
	public Facet reduce(String name, List<Facet> facets) {
		...
		BoundedTreeSet<ShortEntry> ordered = new BoundedTreeSet<ShortEntry>(first.comparatorType.comparator(),
				first.requiredSize);
	 ...
	 *
	 * @param in the in
	 * @return the internal short terms facet
