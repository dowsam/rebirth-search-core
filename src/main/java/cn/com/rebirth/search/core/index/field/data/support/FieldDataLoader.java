 ...
 * Info:rebirth-search-core FieldDataLoader.java 2012-7-6 14:30:43 l.xue.nong$$
 */
...
public class FieldDataLoader {
	...
	public static abstract class FreqsTypeLoader<T extends FieldData> implements TypeLoader<T> {
		...
		/* (non-Javadoc)
		 * @see cn.com.rebirth.search.core.index.field.data.support.FieldDataLoader.TypeLoader#init()
		 */
		@Override
		public void init() {
		}
