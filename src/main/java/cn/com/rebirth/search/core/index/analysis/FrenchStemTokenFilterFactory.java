 ...
 * Info:rebirth-search-core FrenchStemTokenFilterFactory.java 2012-7-6 14:29:19 l.xue.nong$$
 */
...
public class FrenchStemTokenFilterFactory extends AbstractTokenFilterFactory {
	 ...
	 */
	@Inject
	public FrenchStemTokenFilterFactory(Index index, @IndexSettings Settings indexSettings, @Assisted String name,
