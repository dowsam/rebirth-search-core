 ...
 * Info:summall-search-core TimestampFieldMapper.java 2012-3-29 15:01:51 l.xue.nong$$
 */
...
public class TimestampFieldMapper extends DateFieldMapper implements InternalMapper, RootMapper {
	...
	protected TimestampFieldMapper(Field.Store store, Field.Index index, boolean enabled, String path,
		...
		super(new Names(Defaults.NAME, Defaults.NAME, Defaults.NAME, Defaults.NAME), dateTimeFormatter,
				...
				TimeUnit.MILLISECONDS , parseUpperInclusive);
		this.enabled = enabled;
		this.path = path;
	}
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.mapper.core.DateFieldMapper#valueForSearch(org.apache.lucene.document.Fieldable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.mapper.core.DateFieldMapper#valueAsString(org.apache.lucene.document.Fieldable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.mapper.core.DateFieldMapper#parseCreateField(cn.com.summall.search.core.index.mapper.ParseContext)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.mapper.core.DateFieldMapper#contentType()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.mapper.core.DateFieldMapper#merge(cn.com.summall.search.core.index.mapper.Mapper, cn.com.summall.search.core.index.mapper.MergeContext)
	 */
	@Override
