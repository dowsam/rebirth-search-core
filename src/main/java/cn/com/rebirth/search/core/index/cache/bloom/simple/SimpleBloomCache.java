 ...
 * Info:summall-search-core SimpleBloomCache.java 2012-3-29 15:01:50 l.xue.nong$$
 */
...
public class SimpleBloomCache extends AbstractIndexComponent implements BloomCache, IndexReader.ReaderFinishedListener {
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.cache.bloom.BloomCache#clear()
	 */
	@Override
	public void clear() {
		cache.clear();
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.cache.bloom.BloomCache#clear(org.apache.lucene.index.IndexReader)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.cache.bloom.BloomCache#sizeInBytes()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.cache.bloom.BloomCache#sizeInBytes(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.cache.bloom.BloomCache#filter(org.apache.lucene.index.IndexReader, java.lang.String, boolean)
	 */
	@Override
