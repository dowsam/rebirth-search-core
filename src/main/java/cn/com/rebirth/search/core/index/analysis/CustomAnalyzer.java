 ...
 * Info:rebirth-search-core CustomAnalyzer.java 2012-7-6 14:29:44 l.xue.nong$$
 */
...
public final class CustomAnalyzer extends Analyzer implements PositionIncrementGapAnalyzer {
	...
	/* (non-Javadoc)
	 * @see cn.com.rebirth.search.core.index.analysis.PositionIncrementGapAnalyzer#setPositionIncrementGap(int)
	 */
	@Override
