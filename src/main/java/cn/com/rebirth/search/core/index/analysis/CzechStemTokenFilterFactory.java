 ...
 * Info:rebirth-search-core CzechStemTokenFilterFactory.java 2012-7-6 14:29:45 l.xue.nong$$
 */
...
public class CzechStemTokenFilterFactory extends AbstractTokenFilterFactory {
	 ...
	 */
	@Inject
	public CzechStemTokenFilterFactory(Index index, @IndexSettings Settings indexSettings, @Assisted String name,
