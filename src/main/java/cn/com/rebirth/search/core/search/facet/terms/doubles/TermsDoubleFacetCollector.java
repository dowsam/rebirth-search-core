 ...
 * Info:summall-search-core TermsDoubleFacetCollector.java 2012-3-29 15:02:07 l.xue.nong$$
 */
...
public class TermsDoubleFacetCollector extends AbstractFacetCollector {
	...
	public static class AggregatorValueProc extends StaticAggregatorValueProc {
		...
		/* (non-Javadoc)
		 * @see cn.com.summall.search.core.search.facet.terms.doubles.TermsDoubleFacetCollector.StaticAggregatorValueProc#onValue(int, double)
		 */
		@Override
	...
	public static class StaticAggregatorValueProc implements DoubleFieldData.ValueInDocProc, DoubleFieldData.ValueProc {
		...
		/* (non-Javadoc)
		 * @see cn.com.summall.search.core.index.field.data.doubles.DoubleFieldData.ValueProc#onValue(double)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see cn.com.summall.search.core.index.field.data.doubles.DoubleFieldData.ValueInDocProc#onValue(int, double)
		 */
		@Override
		public void onValue(int docId, double value) {
		...
		/* (non-Javadoc)
		 * @see cn.com.summall.search.core.index.field.data.doubles.DoubleFieldData.ValueInDocProc#onMissing(int)
		 */
		@Override
