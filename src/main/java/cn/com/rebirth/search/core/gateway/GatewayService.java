 ...
 * Info:rebirth-search-core GatewayService.java 2012-7-6 14:29:49 l.xue.nong$$
 */
...
public class GatewayService extends AbstractLifecycleComponent<GatewayService> implements ClusterStateListener {
	...
	class GatewayRecoveryListener implements Gateway.GatewayStateRecoveredListener {
		...
		/* (non-Javadoc)
		 * @see cn.com.rebirth.search.core.gateway.Gateway.GatewayStateRecoveredListener#onSuccess(cn.com.rebirth.search.core.cluster.ClusterState)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see cn.com.rebirth.search.core.gateway.Gateway.GatewayStateRecoveredListener#onFailure(java.lang.String)
		 */
		@Override
