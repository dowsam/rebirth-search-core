 ...
 * Info:summall-search-core NettyHttpChannel.java 2012-4-25 10:01:41 l.xue.nong$$
 */
...
public class NettyHttpChannel implements HttpChannel {
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.rest.RestChannel#sendResponse(cn.com.summall.search.core.rest.RestResponse)
     */
    @Override
