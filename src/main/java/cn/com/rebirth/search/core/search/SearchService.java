 ...
 * Info:summall-search-core SearchService.java 2012-3-29 15:02:49 l.xue.nong$$
 */
...
public class SearchService extends AbstractLifecycleComponent<SearchService> {
    ...
    public SearchService(Settings settings, ClusterService clusterService, IndicesService indicesService, IndicesLifecycle indicesLifecycle, ThreadPool threadPool,
        ...
        this.defaultKeepAlive = componentSettings.getAsTime("default_keep_alive", TimeValue.timeValueMinutes(5)).millis();
     ...
     */
    public DfsSearchResult executeDfsPhase(InternalSearchRequest request) throws RestartException {
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public QuerySearchResult executeScan(InternalSearchRequest request) throws RestartException {
        SearchContext context = createContext(request);
        ...
        try {
            if (context.scroll() == null) {
                throw new RestartException("Scroll must be provided when scanning...");
            }
            contextProcessing(context);
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public ScrollQueryFetchSearchResult executeScan(InternalScrollSearchRequest request) throws RestartException {
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public QuerySearchResult executeQueryPhase(InternalSearchRequest request) throws RestartException {
        SearchContext context = createContext(request);
        activeContexts.put(context.id(), context);
        try {
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public ScrollQuerySearchResult executeQueryPhase(InternalScrollSearchRequest request) throws RestartException {
        SearchContext context = findContext(request.id());
        try {
            context.indexShard().searchService().onPreQueryPhase(context);
            long time = System.nanoTime();
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public QuerySearchResult executeQueryPhase(QuerySearchRequest request) throws RestartException {
        SearchContext context = findContext(request.id());
        contextProcessing(context);
        try {
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public QueryFetchSearchResult executeFetchPhase(InternalSearchRequest request) throws RestartException {
        SearchContext context = createContext(request);
        activeContexts.put(context.id(), context);
        contextProcessing(context);
        try {
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public QueryFetchSearchResult executeFetchPhase(QuerySearchRequest request) throws RestartException {
        SearchContext context = findContext(request.id());
        contextProcessing(context);
        try {
            context.searcher().dfSource(new CachedDfSource(request.dfs(), context.similarityService().defaultSearchSimilarity()));
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public ScrollQueryFetchSearchResult executeFetchPhase(InternalScrollSearchRequest request) throws RestartException {
        SearchContext context = findContext(request.id());
        contextProcessing(context);
        try {
            processScroll(request, context);
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public FetchSearchResult executeFetchPhase(FetchSearchRequest request) throws RestartException {
        SearchContext context = findContext(request.id());
        contextProcessing(context);
        try {
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    private SearchContext createContext(InternalSearchRequest request) throws RestartException {
    ...
    class CleanContextOnIndicesLifecycleListener extends IndicesLifecycle.Listener {
        ...
        /* (non-Javadoc)
         * @see cn.com.summall.search.core.indices.IndicesLifecycle.Listener#beforeIndexClosed(cn.com.summall.search.core.index.service.IndexService, boolean)
         */
        @Override
