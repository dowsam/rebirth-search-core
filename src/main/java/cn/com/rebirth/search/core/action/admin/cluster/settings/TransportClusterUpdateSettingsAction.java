 ...
 * Info:summall-search-core TransportClusterUpdateSettingsAction.java 2012-3-29 15:02:54 l.xue.nong$$
 */
...
public class TransportClusterUpdateSettingsAction extends TransportMasterNodeOperationAction<ClusterUpdateSettingsRequest, ClusterUpdateSettingsResponse> {
     ...
     */
    @Override
    protected ClusterUpdateSettingsResponse masterOperation(final ClusterUpdateSettingsRequest request, ClusterState state) throws RestartException {
