 ...
 * Info:summall-search-core ShardGetService.java 2012-3-29 15:00:57 l.xue.nong$$
 */
...
public class ShardGetService extends AbstractIndexShardComponent {
     ...
     */
    public GetResult get(String type, String id, String[] gFields, boolean realtime) throws RestartException {
        currentMetric.inc();
        try {
     ...
     * @throws SumMallSearchException the sum mall search exception
     */
    public GetResult innerGet(String type, String id, String[] gFields, boolean realtime) throws RestartException {
            ...
            if (get.docIdAndVersion() != null) {
                ...
                if (fieldSelector != null) {
                    ...
                    try {
                        ...
                        throw new RestartException("Failed to get type [" + type + "] and id [" + id + "]", e);
                    }
