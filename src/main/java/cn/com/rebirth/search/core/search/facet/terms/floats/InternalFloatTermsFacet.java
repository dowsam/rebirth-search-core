 ...
 * Info:summall-search-core InternalFloatTermsFacet.java 2012-3-29 15:00:44 l.xue.nong$$
 */
...
/**
 * The Class InternalFloatTermsFacet.
 *
 * @author l.xue.nong
 */
public class InternalFloatTermsFacet extends InternalTermsFacet {
	...
	/**
	 * Instantiates a new internal float terms facet.
	 */
	 ...
	 */
	public InternalFloatTermsFacet(String name, ComparatorType comparatorType, int requiredSize,
			Collection<FloatEntry> entries, long missing, long total) {
		this.name = name;
	...
	public Facet reduce(String name, List<Facet> facets) {
		...
		BoundedTreeSet<FloatEntry> ordered = new BoundedTreeSet<FloatEntry>(first.comparatorType.comparator(),
				first.requiredSize);
	 ...
	 *
	 * @param in the in
	 * @return the internal float terms facet
