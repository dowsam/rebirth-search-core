 ...
 * Info:summall-search-core SingleValueIntFieldData.java 2012-3-29 15:01:39 l.xue.nong$$
 */
...
public class SingleValueIntFieldData extends IntFieldData {
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.field.data.ints.IntFieldData#computeSizeInBytes()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.field.data.ints.IntFieldData#forEachValueInDoc(int, cn.com.summall.search.core.index.field.data.ints.IntFieldData.ValueInDocProc)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.field.data.ints.IntFieldData#value(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cn.com.summall.search.core.index.field.data.ints.IntFieldData#values(int)
	 */
	@Override
