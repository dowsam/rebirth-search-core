 ...
 * Info:summall-search-core TransportDeleteIndexAction.java 2012-3-29 15:02:16 l.xue.nong$$
 */
...
public class TransportDeleteIndexAction extends TransportMasterNodeOperationAction<DeleteIndexRequest, DeleteIndexResponse> {
    ...
    protected void doExecute(DeleteIndexRequest request, ActionListener<DeleteIndexResponse> listener) {
        if (disableDeleteAllIndices && (request.indices() == null || request.indices().length == 0)) {
            throw new RestartIllegalArgumentException("deleting all indices is disabled");
        }
     ...
     */
    @Override
    protected DeleteIndexResponse masterOperation(DeleteIndexRequest request, final ClusterState state) throws RestartException {
