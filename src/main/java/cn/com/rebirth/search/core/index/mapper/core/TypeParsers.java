 ...
 * Info:summall-search-core TypeParsers.java 2012-3-29 15:02:00 l.xue.nong$$
 */
...
public class TypeParsers {
	 ...
	 */
	public static void parseNumberField(NumberFieldMapper.Builder builder, String name, Map<String, Object> numberNode,
	 ...
	 * @param parserContext the parser context
	 */
	public static void parseField(AbstractFieldMapper.Builder builder, String name, Map<String, Object> fieldNode,
			Mapper.TypeParser.ParserContext parserContext) {
		for (Map.Entry<String, Object> entry : fieldNode.entrySet()) {
			...
			if (propName.equals("index_name")) {
				...
				if (analyzer == null) {
					throw new MapperParsingException("Analyzer [" + propNode.toString() + "] not found for field ["
							+ name + "]");
				}
	...
	/**
	 * Parses the date time formatter.
	 *
