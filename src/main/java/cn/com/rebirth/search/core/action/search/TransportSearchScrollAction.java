 ...
 * Info:summall-search-core TransportSearchScrollAction.java 2012-3-29 15:01:29 l.xue.nong$$
 */
    ...
    protected void doExecute(SearchScrollRequest request, ActionListener<SearchResponse> listener) {
        try {
            ...
            if (scrollId.type().equals(QUERY_THEN_FETCH_TYPE)) {
                ...
                throw new RestartIllegalArgumentException("Scroll id type [" + scrollId.type() + "] unrecognized");
            }
        } catch (Exception e) {
