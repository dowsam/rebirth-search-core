 ...
 * Info:summall-search-core LowerCaseTokenFilterFactory.java 2012-3-29 15:01:01 l.xue.nong$$
 */
...
public class LowerCaseTokenFilterFactory extends AbstractTokenFilterFactory {
	...
	public TokenStream create(TokenStream tokenStream) {
		if (lang == null) {
			...
			throw new RestartIllegalArgumentException("language [" + lang + "] not support for lower case");
		}
	}
}
