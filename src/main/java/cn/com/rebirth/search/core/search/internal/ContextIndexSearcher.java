 ...
 * Info:rebirth-search-core ContextIndexSearcher.java 2012-7-6 14:29:32 l.xue.nong$$
 */
...
public class ContextIndexSearcher extends ExtendedIndexSearcher {
	...
	public TopFieldDocs search(Weight weight, Filter filter, int nDocs, Sort sort, boolean fillFields)
		...
		TopFieldCollector collector = TopFieldCollector.create(sort, nDocs, fillFields, searchContext.trackScores(),
				searchContext.trackScores(), !weight.scoresDocsOutOfOrder());
