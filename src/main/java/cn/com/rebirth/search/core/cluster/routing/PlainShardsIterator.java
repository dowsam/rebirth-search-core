 ...
 * Info:summall-search-core PlainShardsIterator.java 2012-3-29 15:01:29 l.xue.nong$$
 */
...
public class PlainShardsIterator implements ShardsIterator {
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.cluster.routing.ShardsIterator#remaining()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.cluster.routing.ShardsIterator#firstOrNull()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.cluster.routing.ShardsIterator#nextOrNull()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.cluster.routing.ShardsIterator#size()
     */
    @Override
    public int size() {
        return size;
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.cluster.routing.ShardsIterator#sizeActive()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.cluster.routing.ShardsIterator#assignedReplicasIncludingRelocating()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.cluster.routing.ShardsIterator#asUnordered()
     */
    @Override
