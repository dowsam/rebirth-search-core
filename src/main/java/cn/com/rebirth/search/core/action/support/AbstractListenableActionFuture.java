 ...
 * Info:summall-search-core AbstractListenableActionFuture.java 2012-3-29 15:01:10 l.xue.nong$$
 */
...
public abstract class AbstractListenableActionFuture<T, L> extends AdapterActionFuture<T, L> implements ListenableActionFuture<T> {
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.action.ListenableActionFuture#addListener(cn.com.summall.search.core.action.ActionListener)
     */
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.action.ListenableActionFuture#addListener(java.lang.Runnable)
     */
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.commons.util.concurrent.BaseFuture#done()
     */
    @Override
    protected void done() {
        super.done();
