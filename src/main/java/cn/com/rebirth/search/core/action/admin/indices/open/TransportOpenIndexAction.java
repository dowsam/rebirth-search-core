 ...
 * Info:summall-search-core TransportOpenIndexAction.java 2012-3-29 15:01:09 l.xue.nong$$
 */
...
public class TransportOpenIndexAction extends TransportMasterNodeOperationAction<OpenIndexRequest, OpenIndexResponse> {
     ...
     */
    @Override
    protected OpenIndexResponse masterOperation(OpenIndexRequest request, ClusterState state) throws RestartException {
