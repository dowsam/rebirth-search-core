 ...
 * Info:summall-search-core PlainShardIterator.java 2012-3-29 15:00:55 l.xue.nong$$
 */
...
public class PlainShardIterator extends PlainShardsIterator implements ShardIterator {
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.cluster.routing.PlainShardsIterator#reset()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.cluster.routing.ShardIterator#shardId()
     */
    @Override
