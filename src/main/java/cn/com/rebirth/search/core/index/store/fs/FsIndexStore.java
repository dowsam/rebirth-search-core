 ...
 * Info:summall-search-core FsIndexStore.java 2012-3-29 15:01:29 l.xue.nong$$
 */
...
public abstract class FsIndexStore extends AbstractIndexStore {
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.index.store.support.AbstractIndexStore#canDeleteUnallocated(cn.com.summall.search.core.index.shard.ShardId)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.index.store.support.AbstractIndexStore#deleteUnallocated(cn.com.summall.search.core.index.shard.ShardId)
     */
    @Override
    public void deleteUnallocated(ShardId shardId) throws IOException {
        ...
        if (indexService.hasShard(shardId.id())) {
            throw new RestartIllegalStateException(shardId + " allocated, can't be deleted");
        }
