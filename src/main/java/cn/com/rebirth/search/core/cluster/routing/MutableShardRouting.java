 ...
 * Info:rebirth-search-core MutableShardRouting.java 2012-7-6 14:30:23 l.xue.nong$$
 */
...
public class MutableShardRouting extends ImmutableShardRouting {
	 ...
	 * @param version the version
	 */
	public MutableShardRouting(String index, int shardId, String currentNodeId, boolean primary,
	 ...
	 * @param version the version
	 */
	public MutableShardRouting(String index, int shardId, String currentNodeId, String relocatingNodeId,
