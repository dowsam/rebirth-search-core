 ...
 * Info:rebirth-search-core ParseContext.java 2012-7-6 14:30:08 l.xue.nong$$
 */
...
public class ParseContext {
	 ...
	 * @param path the path
	 */
	public ParseContext(String index, @Nullable Settings indexSettings, DocumentMapperParser docMapperParser,
			DocumentMapper docMapper, ContentPath path) {
		this.index = index;
