 ...
 * Info:rebirth-search-core BlockJoinQuery.java 2012-7-6 14:30:35 l.xue.nong$$
 */
...
public class BlockJoinQuery extends Query {
	...
	static class BlockJoinScorer extends Scorer {
		 ...
		 * @param childCollector the child collector
		 */
		public BlockJoinScorer(Weight weight, Scorer childScorer, FixedBitSet parentBits, int firstChildDoc,
	...
	public Query rewrite(IndexReader reader) throws IOException {
		...
		if (childRewrite != childQuery) {
			Query rewritten = new BlockJoinQuery(childQuery, childRewrite, parentsFilter, scoreMode)
					.setCollector(childCollector);
	...
	public boolean equals(Object _other) {
		if (_other instanceof BlockJoinQuery) {
			...
			return origChildQuery.equals(other.origChildQuery) && parentsFilter.equals(other.parentsFilter)
	...
	@Override
	public Object clone() {
		return new BlockJoinQuery((Query) origChildQuery.clone(), parentsFilter, scoreMode)
				.setCollector(childCollector);
	}
}
