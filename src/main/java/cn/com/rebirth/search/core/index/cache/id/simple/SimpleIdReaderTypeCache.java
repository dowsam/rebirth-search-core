 ...
 * Info:summall-search-core SimpleIdReaderTypeCache.java 2012-3-29 15:01:13 l.xue.nong$$
 */
...
public class SimpleIdReaderTypeCache implements IdReaderTypeCache {
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.index.cache.id.IdReaderTypeCache#parentIdByDoc(int)
     */
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.index.cache.id.IdReaderTypeCache#docById(cn.com.summall.search.commons.BytesWrap)
     */
