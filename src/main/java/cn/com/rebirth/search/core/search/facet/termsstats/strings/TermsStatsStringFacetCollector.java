 ...
 * Info:rebirth-search-core TermsStatsStringFacetCollector.java 2012-7-6 14:29:38 l.xue.nong$$
 */
...
public class TermsStatsStringFacetCollector extends AbstractFacetCollector {
	...
	public Facet facet() {
		...
		if (size == 0) {
			...
			return new InternalTermsStatsStringFacet(facetName, comparatorType, 0, aggregator.entries.values(),
					aggregator.missing);
		}
	...
	public static class ScriptAggregator extends Aggregator {
		...
		/* (non-Javadoc)
		 * @see cn.com.rebirth.search.core.search.facet.termsstats.strings.TermsStatsStringFacetCollector.Aggregator#onValue(int, java.lang.String)
		 */
		@Override
		public void onValue(int docId, String value) {
			InternalTermsStatsStringFacet.StringEntry stringEntry = entries.get(value);
