 ...
 * Info:rebirth-search-core HasChildQueryParser.java 2012-7-6 14:29:12 l.xue.nong$$
 */
		...
		while ((token = parser.nextToken()) != XContentParser.Token.END_OBJECT) {
			if (token == XContentParser.Token.FIELD_NAME) {
				...
				if ("query".equals(currentFieldName)) {
					...
					throw new QueryParsingException(parseContext.index(), "[has_child] query does not support ["
							+ currentFieldName + "]");
				}
