 ...
 * Info:summall-search-core TermsShortFacetCollector.java 2012-3-29 15:02:26 l.xue.nong$$
 */
...
public class TermsShortFacetCollector extends AbstractFacetCollector {
	...
	public static class AggregatorValueProc extends StaticAggregatorValueProc {
		...
		/* (non-Javadoc)
		 * @see cn.com.summall.search.core.search.facet.terms.shorts.TermsShortFacetCollector.StaticAggregatorValueProc#onValue(int, short)
		 */
		@Override
	...
	public static class StaticAggregatorValueProc implements ShortFieldData.ValueInDocProc, ShortFieldData.ValueProc {
		...
		/* (non-Javadoc)
		 * @see cn.com.summall.search.core.index.field.data.shorts.ShortFieldData.ValueProc#onValue(short)
		 */
		@Override
		...
		/* (non-Javadoc)
		 * @see cn.com.summall.search.core.index.field.data.shorts.ShortFieldData.ValueInDocProc#onValue(int, short)
		 */
		@Override
		public void onValue(int docId, short value) {
		...
		/* (non-Javadoc)
		 * @see cn.com.summall.search.core.index.field.data.shorts.ShortFieldData.ValueInDocProc#onMissing(int)
		 */
		@Override
