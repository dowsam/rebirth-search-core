 ...
 * Info:rebirth-search-core CustomAnalyzerProvider.java 2012-7-6 14:30:45 l.xue.nong$$
 */
...
public class CustomAnalyzerProvider extends AbstractIndexAnalyzerProvider<CustomAnalyzer> {
	 ...
	 */
	@Inject
	public CustomAnalyzerProvider(Index index, @IndexSettings Settings indexSettings, @Assisted String name,
	...
	public void build(AnalysisService analysisService) {
		...
		this.customAnalyzer = new CustomAnalyzer(tokenizer, charFilters.toArray(new CharFilterFactory[charFilters
				.size()]), tokenFilters.toArray(new TokenFilterFactory[tokenFilters.size()]));
	}
