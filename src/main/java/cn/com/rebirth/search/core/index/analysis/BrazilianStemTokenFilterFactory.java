 ...
 * Info:rebirth-search-core BrazilianStemTokenFilterFactory.java 2012-7-6 14:28:55 l.xue.nong$$
 */
...
public class BrazilianStemTokenFilterFactory extends AbstractTokenFilterFactory {
	 ...
	 */
	@Inject
	public BrazilianStemTokenFilterFactory(Index index, @IndexSettings Settings indexSettings, @Assisted String name,
