...
public class InternalStringTermsFacet extends InternalTermsFacet {
	 ...
	 */
	public InternalStringTermsFacet(String name, ComparatorType comparatorType, int requiredSize,
			Collection<StringEntry> entries, long missing, long total) {
		this.name = name;
	...
	public Facet reduce(String name, List<Facet> facets) {
		...
		BoundedTreeSet<StringEntry> ordered = new BoundedTreeSet<StringEntry>(first.comparatorType.comparator(),
				first.requiredSize);
	 ...
	 *
	 * @param in the in
	 * @return the internal string terms facet
