 ...
 * Info:summall-search-core TransportRefreshAction.java 2012-3-29 15:02:38 l.xue.nong$$
 */
...
public class TransportRefreshAction extends TransportBroadcastOperationAction<RefreshRequest, RefreshResponse, ShardRefreshRequest, ShardRefreshResponse> {
    ...
    /* (non-Javadoc)
     * @see cn.com.summall.search.core.action.support.broadcast.TransportBroadcastOperationAction#ignoreException(java.lang.Throwable)
     */
    @Override
     ...
     */
    @Override
    protected ShardRefreshResponse shardOperation(ShardRefreshRequest request) throws RestartException {
